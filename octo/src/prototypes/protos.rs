...
fn prototypes_round() -> Vec<Vec<Type>> {
    PASS_THROUGH_ROUND.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_trunc() -> Vec<Vec<Type>> {
    PASS_THROUGH_TRUNC.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_abs() -> Vec<Vec<Type>> {
    PASS_THROUGH_ABS.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_sign() -> Vec<Vec<Type>> {
    PASS_THROUGH_SIGN.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_floor() -> Vec<Vec<Type>> {
    PASS_THROUGH_FLOOR.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_ceil() -> Vec<Vec<Type>> {
    PASS_THROUGH_CEIL.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_fract() -> Vec<Vec<Type>> {
    PASS_THROUGH_FRACT.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_radians() -> Vec<Vec<Type>> {
    PASS_THROUGH_RADIANS.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_degrees() -> Vec<Vec<Type>> {
    PASS_THROUGH_DEGREES.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_sin() -> Vec<Vec<Type>> {
    PASS_THROUGH_SIN.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_cos() -> Vec<Vec<Type>> {
    PASS_THROUGH_COS.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_tan() -> Vec<Vec<Type>> {
    PASS_THROUGH_TAN.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_asin() -> Vec<Vec<Type>> {
    PASS_THROUGH_ASIN.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_acos() -> Vec<Vec<Type>> {
    PASS_THROUGH_ACOS.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_atan() -> Vec<Vec<Type>> {
    PASS_THROUGH_ATAN.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_sinh() -> Vec<Vec<Type>> {
    PASS_THROUGH_SINH.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_cosh() -> Vec<Vec<Type>> {
    PASS_THROUGH_COSH.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_tanh() -> Vec<Vec<Type>> {
    PASS_THROUGH_TANH.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_asinh() -> Vec<Vec<Type>> {
    PASS_THROUGH_ASINH.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_acosh() -> Vec<Vec<Type>> {
    PASS_THROUGH_ACOSH.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_atanh() -> Vec<Vec<Type>> {
    PASS_THROUGH_ATANH.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_atan2() -> Vec<Vec<Type>> {
    PASS_THROUGH_ATAN2.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_pow() -> Vec<Vec<Type>> {
    PASS_THROUGH_POW.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_exp() -> Vec<Vec<Type>> {
    PASS_THROUGH_EXP.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_log() -> Vec<Vec<Type>> {
    PASS_THROUGH_LOG.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_exp2() -> Vec<Vec<Type>> {
    PASS_THROUGH_EXP2.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_log2() -> Vec<Vec<Type>> {
    PASS_THROUGH_LOG2.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_sqrt() -> Vec<Vec<Type>> {
    PASS_THROUGH_SQRT.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_min() -> Vec<Vec<Type>> {
    PASS_THROUGH_MIN.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_max() -> Vec<Vec<Type>> {
    PASS_THROUGH_MAX.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_clamp() -> Vec<Vec<Type>> {
    PASS_THROUGH_CLAMP.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_length() -> Vec<Vec<Type>> {
    PASS_THROUGH_LENGTH.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_cross() -> Vec<Vec<Type>> {
    PASS_THROUGH_CROSS.iter().map(|x| vec![*x]).collect()
}
...
fn prototypes_normalize() -> Vec<Vec<Type>> {
    PASS_THROUGH_NORMALIZE.iter().map(|x| vec![*x]).collect()
}
